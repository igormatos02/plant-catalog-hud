...
export const searchPlants = async (query, language = 'en') => {
    ...
    - "image_search_term" (a concise English term for fetching a real photo of this specimen from Unsplash)
...
export const getPlantDetails = async (plantName, language = 'en') => {
    ...
    - image_search_term: A concise English term for fetching a real photo of this specimen from Unsplash.
    - image_prompt: A high-fidelity descriptive prompt for an AI image generator (remain in English).
