export const translations = {
    ...
    de: {
        ...
        metrics: {
            ...
            specimenSize: "GRÖSSE",
            timeToAdult: "ZEIT BIS ERWACHSEN",
    ...
    uk: {
        ...
        metrics: {
            ...
            timeToAdult: "ЧАС ДО ДОРОСЛІШАННЯ",
    ...
    my: {
        ...
        downloadPdf: "PDF အစီရင်ခံစာကို ဒေါင်းလုဒ်လုပ်ရန်",
        tabs: {
            geral: "အထွေထွေ",
            class: "အမျိုးအစား",
            order: "မျိုးစဉ်",
        ...
        metrics: {
            ...
            timeToAdult: "အရွယ်ရောက်ရန်အချိန်",
